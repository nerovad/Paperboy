...
[
  'Companions',
  {
    ...
    header: [
      ...
      ['postal_address_last_line',                'postal_address_last_line',                'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_1',                   'postal_address_line_1',                   'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_2',                   'postal_address_line_2',                   'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_3',                   'postal_address_line_3',                   'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_4',                   'postal_address_line_4',                   'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_5',                   'postal_address_line_5',                   'varchar(100)',  'NULL',                   nil],
      ['postal_address_line_6',                   'postal_address_line_6',                   'varchar(100)',  'NULL',                   nil],
      ...
      ['envelope_size',                           'envelope_size',                           'bigint',        'NULL',                   nil],
