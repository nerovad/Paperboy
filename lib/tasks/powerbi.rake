...
namespace :powerbi do
  ...
  task get_workspace_id: :environment do
    ...
    tenant_id = ENV.fetch('POWERBI_TENANT_ID', nil)
    ...
    request.set_form_data(
      ...
      'client_id' => ENV.fetch('POWERBI_CLIENT_ID', nil),
      'client_secret' => ENV.fetch('POWERBI_CLIENT_SECRET', nil),
      'scope' => ENV.fetch('POWERBI_SCOPE', nil)
    )
