...
# Mirrors the ACL definitions across Paperboy_Dev / _Stage / _Prod:
#
#   dev$   bin/rails acl:dump MERGE=1     # add dev's groups and grants to the file
...
namespace :acl do
  desc 'Dump this environment ACL definitions to db/acl.yml. MERGE=1 unions them into the existing file instead of overwriting'
