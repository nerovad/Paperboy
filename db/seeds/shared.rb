...
module Seeds
  ...
  def phone
    if rand < 0.2
      "805/#{rand(600..999)}-#{rand(1000..9999)}"
    else
      format('%03d%03d%04d', 310, rand(600..999), rand(1000..9999))
    end
  end

  def employee_id = rand(100_000..999_999).to_s
  def plate = [('A'..'Z').to_a.sample(3).join, rand(100..999), ('A'..'Z').to_a.sample].join
end
