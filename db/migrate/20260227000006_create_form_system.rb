class CreateFormSystem < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :form_fields, %i[form_template_id page_number]
    add_index :form_fields, %i[form_template_id position]
    ...
    add_index :form_template_statuses, %i[form_template_id key], unique: true
    add_index :form_template_statuses, %i[form_template_id position]
    ...
    add_index :form_template_routing_steps, %i[form_template_id step_number], unique: true, name: 'idx_routing_steps_template_step'
  end
end
