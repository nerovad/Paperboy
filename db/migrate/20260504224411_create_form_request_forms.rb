class CreateFormRequestForms < ActiveRecord::Migration[7.1]
  def change
    create_table :form_request_forms do |t|
    ...
    add_index :form_request_forms, :approver_id
    add_index :form_request_forms, :employee_id
  end
end
