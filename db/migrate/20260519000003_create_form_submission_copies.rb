class CreateFormSubmissionCopies < ActiveRecord::Migration[8.0]
  def change
    ...
    add_index :form_submission_copies, [:submission_type, :submission_id], name: 'index_form_submission_copies_on_submission'
    add_index :form_submission_copies, :recipient_employee_id
    add_index :form_submission_copies,
              [:submission_type, :submission_id, :recipient_employee_id],
              unique: true,
