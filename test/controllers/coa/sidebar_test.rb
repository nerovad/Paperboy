...
class CoaSidebarTest < ActionController::TestCase
  ...
  test 'groups every sidebar action and expands the current group' do
    ...
    assert_sidebar_group 'Lookups', ['Billing Lookup', 'Employee Lookup'], open: true
    assert_select '.coa-sidebar details.nav-group a.nav-link.active', text: 'Employee Lookup'
