...
class FormGenerator
    ...
    content = <<~RUBY
      ...
      #{'  '}
        def self.page_header(page_num)
          headers = #{form_template.page_headers}
      #{'    '}
          case page_num
          when 1
            "Employee Info"
  ...
  def generate_controller
    ...
    content = <<~RUBY
      ...
      class Forms::#{form_template.class_name.pluralize}Controller < Forms::BaseController
  ...
  def generate_view
    view_dir = Rails.root.join("app/views/forms/#{form_template.plural_file_name}")
  ...
  def add_route
    ...
    route_line = "  resources :#{form_template.plural_file_name}, " \
                 "controller: 'forms/#{form_template.plural_file_name}'\n"
