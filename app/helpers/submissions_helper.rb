...
module SubmissionsHelper
  ...
  def can_change_submission_status?(record)
    Forms::SubmissionPolicy.status_dropdown?(record) &&
      submission_action_permitted?(record, 'change_status')
  end
  ...
  def can_edit_submission?(record)
    submission_action_permitted?(record, 'edit')
  end
  ...
  def submission_action_permitted?(record, action)
