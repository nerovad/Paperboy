...
module Forms
  class Field < ApplicationRecord
    ...
    def self.model_name = ActiveModel::Name.new(self, nil, 'FormField')
    ...
    belongs_to :form_template, class_name: 'Forms::Template'
    ...
    validates :restricted_to_org_filter_level,
              inclusion: { in: TemplateRoutingStep::ORG_FILTER_LEVELS },
              allow_blank: true
    ...
    def org_filter_label
      TemplateRoutingStep::ORG_FILTER_LABELS[restricted_to_org_filter_level]
    end
