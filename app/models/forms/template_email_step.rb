...
module Forms
  class TemplateEmailStep < ApplicationRecord
    self.table_name = 'form_template_email_steps'

    def self.model_name = ActiveModel::Name.new(self, nil, 'FormTemplateEmailStep')
