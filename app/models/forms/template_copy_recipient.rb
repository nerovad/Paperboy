...
module Forms
  class TemplateCopyRecipient < ApplicationRecord
    self.table_name = 'form_template_copy_recipients'

    def self.model_name = ActiveModel::Name.new(self, nil, 'FormTemplateCopyRecipient')
