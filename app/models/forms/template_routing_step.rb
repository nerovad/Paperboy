...
module Forms
  class TemplateRoutingStep < ApplicationRecord
    self.table_name = 'form_template_routing_steps'

    def self.model_name = ActiveModel::Name.new(self, nil, 'FormTemplateRoutingStep')
