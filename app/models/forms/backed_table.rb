  ...
  class BackedTable
    ...
    class << self
      ...
      def all
        ...
        Template.where(records_table: true).includes(:form_fields).order(:name).filter_map do |template|
      ...
      def find(slug)
        ...
        template = Template.find_by(id: id, records_table: true)
      ...
      def enabled?
        Template.column_names.include?('records_table')
      end
