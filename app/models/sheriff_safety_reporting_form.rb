...
class SheriffSafetyReportingForm < ApplicationRecord
  ...
  # Sheriff Safety Reporting Form → OSHA Reporting field mapping
  ...
  # Create a pre-filled OSHA Report from this Sheriff Safety Reporting Form's data.
  ...
  def create_osha_report!(approver_id:)
    ...
    attrs[:sheriff_safety_reporting_form_id] = id
