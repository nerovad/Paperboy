...
class PcardInventory < ApplicationRecord
  ...
  registry_fed_by PcardRequestForm,
                  ...
                  agency: ->(form) { Coa::Agency.find_by(agency_id: form.agency)&.long_name || form.agency },
                  division: ->(form) { Coa::Division.find_by(division_id: form.division)&.long_name || form.division },
                  phone: :phone,
