class ArizonaCardinalsFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @arizona_cardinals_form = ArizonaCardinalsForm.new
  ...
  def create
    ...
    @arizona_cardinals_form = ArizonaCardinalsForm.new(arizona_cardinals_form_params)
    @arizona_cardinals_form.employee_id = employee_id if @arizona_cardinals_form.respond_to?(:employee_id=)

    if @arizona_cardinals_form.save
  ...
  def arizona_cardinals_form_params
    # Only the baseline fields you asked for
    params.require(:arizona_cardinals_form).permit(
