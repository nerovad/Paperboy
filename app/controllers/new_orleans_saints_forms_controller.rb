class NewOrleansSaintsFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @new_orleans_saints_form = NewOrleansSaintsForm.new
  ...
  def create
    ...
    @new_orleans_saints_form = NewOrleansSaintsForm.new(new_orleans_saints_form_params)
    @new_orleans_saints_form.employee_id = employee_id if @new_orleans_saints_form.respond_to?(:employee_id=)

    if @new_orleans_saints_form.save
  ...
  def new_orleans_saints_form_params
    # Only the baseline fields you asked for
    params.require(:new_orleans_saints_form).permit(
