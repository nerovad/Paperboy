...
module P2m
  ...
  class BaseController < ApplicationController
    ...
    # this is the real gate: without it Print 2 Mail would stay reachable by
    ...
    def require_app_access
      return if current_user.present? && helpers.can_access_app?('p2m')

      redirect_to root_path, alert: 'You do not have access to Print 2 Mail.'
    end
  end
end
