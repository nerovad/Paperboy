...
module Billing
  # Base controller for the Billing app. Every Billing controller should
  ...
  class BaseController < ApplicationController
    ...
    def require_app_access
      return if current_user.present? && helpers.can_access_app?('billing')

      redirect_to root_path, alert: 'You do not have access to Billing.'
    end
  end
end
