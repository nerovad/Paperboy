class ChicagoBlackhawksFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @chicago_blackhawks_form = ChicagoBlackhawksForm.new
  ...
  def create
    ...
    @chicago_blackhawks_form = ChicagoBlackhawksForm.new(chicago_blackhawks_form_params)
    @chicago_blackhawks_form.employee_id = employee_id if @chicago_blackhawks_form.respond_to?(:employee_id=)

    if @chicago_blackhawks_form.save
  ...
  def chicago_blackhawks_form_params
    # Only the baseline fields you asked for
    params.require(:chicago_blackhawks_form).permit(
