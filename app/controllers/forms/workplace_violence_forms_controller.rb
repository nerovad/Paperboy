...
module Forms
  class WorkplaceViolenceFormsController < Forms::BaseController
    ...
    def pdf
      pdf_data = WorkplaceViolenceFormPdfGenerator.generate(@workplace_violence_form)
    ...
    def set_workplace_violence_form
      @workplace_violence_form = WorkplaceViolenceForm.find(params[:id])
    end
    ...
    def setup_form_options
      ...
      agency_id     = @workplace_violence_form&.agency
      division_id   = @workplace_violence_form&.division
      department_id = @workplace_violence_form&.department
    ...
    def workplace_violence_form_params
      # Only the baseline fields you asked for
      params.require(:workplace_violence_form).permit(
