...
module Forms
  class NoticeOfChangeFormsController < Forms::BaseController
    ...
    def setup_form_options
      ...
      agency_id     = @notice_of_change_form&.agency
      division_id   = @notice_of_change_form&.division
      department_id = @notice_of_change_form&.department
