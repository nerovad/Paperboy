...
module Forms
  class IdBadgeRequestFormsController < Forms::BaseController
    ...
    def create
      ...
      @id_badge_request_form = IdBadgeRequestForm.new(id_badge_request_form_params)
      ...
      if @id_badge_request_form.save
        ...
        @id_badge_request_form.start_approval!
    ...
    def pdf
      pdf_data = IdBadgeRequestFormPdfGenerator.generate(@id_badge_request_form)

      send_data pdf_data,
                filename: "IdBadgeRequestForm_#{@id_badge_request_form.id}.pdf",
    ...
    def set_id_badge_request_form
      @id_badge_request_form = IdBadgeRequestForm.find(params[:id])
    end
    ...
    def setup_form_options
      ...
      agency_id     = @id_badge_request_form&.agency
      division_id   = @id_badge_request_form&.division
      department_id = @id_badge_request_form&.department

      @prefill_data = {
        employee_id: @id_badge_request_form&.employee_id,
        name: @id_badge_request_form&.name,
        phone: @id_badge_request_form&.phone,
        email: @id_badge_request_form&.email,
        agency: agency_id,
        division: division_id,
        department: department_id,
        unit: @id_badge_request_form&.unit
      }
    ...
    def id_badge_request_form_params
      # Only the baseline fields you asked for
      params.require(:id_badge_request_form).permit(
