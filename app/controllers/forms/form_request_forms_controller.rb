...
module Forms
  class FormRequestFormsController < Forms::BaseController
    ...
    def pdf
      pdf_data = FormRequestFormPdfGenerator.generate(@form_request_form)
    ...
    def set_form_request_form
      @form_request_form = FormRequestForm.find(params[:id])
    end
    ...
    def setup_form_options
      ...
      agency_id     = @form_request_form&.agency
      division_id   = @form_request_form&.division
      department_id = @form_request_form&.department
