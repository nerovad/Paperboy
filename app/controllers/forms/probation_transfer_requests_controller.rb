...
module Forms
  class ProbationTransferRequestsController < Forms::BaseController
      ...
      respond_to do |format|
        ...
        format.pdf do
          render pdf: "transfer_request_#{@probation_transfer_request.id}",
                 template: 'forms/probation_transfer_requests/pdf',
    ...
    def approve
      ...
      return redirect_to inbox_queue_path, alert: 'Please choose an approved destination.' if options.any? && selected_dest.blank?
      ...
      @form_pages = [
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'desired_transfer_destination', label: 'Desired Transfer Destination', type: 'multi-select',
              options: ['East County', 'West County', 'Downtown', 'Remote', 'Other'] }
          ]
        }
      ]
