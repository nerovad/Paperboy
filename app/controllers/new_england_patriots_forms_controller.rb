class NewEnglandPatriotsFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @new_england_patriots_form = NewEnglandPatriotsForm.new
  ...
  def create
    ...
    @new_england_patriots_form = NewEnglandPatriotsForm.new(new_england_patriots_form_params)
    @new_england_patriots_form.employee_id = employee_id if @new_england_patriots_form.respond_to?(:employee_id=)

    if @new_england_patriots_form.save
  ...
  def new_england_patriots_form_params
    # Only the baseline fields you asked for
    params.require(:new_england_patriots_form).permit(
