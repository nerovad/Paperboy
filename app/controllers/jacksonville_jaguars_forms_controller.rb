class JacksonvilleJaguarsFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @jacksonville_jaguars_form = JacksonvilleJaguarsForm.new
  ...
  def create
    ...
    @jacksonville_jaguars_form = JacksonvilleJaguarsForm.new(jacksonville_jaguars_form_params)
    @jacksonville_jaguars_form.employee_id = employee_id if @jacksonville_jaguars_form.respond_to?(:employee_id=)

    if @jacksonville_jaguars_form.save
  ...
  def jacksonville_jaguars_form_params
    # Only the baseline fields you asked for
    params.require(:jacksonville_jaguars_form).permit(
