class SonicTheHedgehogFormsController < ApplicationController
  # Minimal controller for the two-page template (Employee Info + Agency Info)

  def new
    @sonic_the_hedgehog_form = SonicTheHedgehogForm.new
  ...
  def create
    ...
    @sonic_the_hedgehog_form = SonicTheHedgehogForm.new(sonic_the_hedgehog_form_params)
    @sonic_the_hedgehog_form.employee_id = employee_id if @sonic_the_hedgehog_form.respond_to?(:employee_id=)

    if @sonic_the_hedgehog_form.save
  ...
  def sonic_the_hedgehog_form_params
    # Only the baseline fields you asked for
    params.require(:sonic_the_hedgehog_form).permit(
