...
class TaskReassignmentsController < ApplicationController
  ...
  def reassign
    ...
    redirect_to inbox_queue_path, alert: 'Task not found.' and return unless task
  ...
  def take_back
    ...
    redirect_to inbox_queue_path, alert: 'You cannot take back this task.' and return unless task.can_take_back?(current_employee_id)
  ...
  def history
    ...
    render json: { error: 'Task not found' }, status: :not_found and return unless task
